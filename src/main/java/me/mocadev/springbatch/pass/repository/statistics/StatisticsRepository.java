package me.mocadev.springbatch.pass.repository.statistics;
...
public interface StatisticsRepository extends JpaRepository<StatisticsEntity, Integer> {
	...
	@Query(value = "SELECT new me.mocadev.springbatch.pass.repository.statistics.AggregatedStatistics(s.statisticsAt, " +
		" SUM(s.allCount), SUM(s.attendedCount), SUM(s.cancelledCount)) " +
